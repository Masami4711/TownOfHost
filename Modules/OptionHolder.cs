...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        public static CustomOption MadmateCanAlsoBeExposedToImpostor;
        ...
        public static void Load()
        {
            ...
            MadmateCanVent = CustomOption.Create(10010, TabGroup.ImpostorRoles, Color.white, "MadmateCanVent", true, CustomRoleSpawnChances[CustomRoles.Madmate]);
            MadmateNoticeImpostors = CustomOption.Create(10010, TabGroup.ImpostorRoles, Color.white, "MadmateNoticeImpostors", true, CustomRoleSpawnChances[CustomRoles.Madmate]);
            MadmateCanAlsoBeExposedToImpostor = CustomOption.Create(10011, TabGroup.ImpostorRoles, Color.white, "MadmateCanAlsoBeExposedToImpostor", false, MadmateNoticeImpostors);
            MadmateGuardImpostorKill = CustomOption.Create(10012, TabGroup.ImpostorRoles, Color.white, "MadmateGuardImpostorKill", false, CustomRoleSpawnChances[CustomRoles.Madmate]);
            MadmateCanSeeWhoTriedToKill = CustomOption.Create(10013, TabGroup.ImpostorRoles, Color.white, "MadmateCanSeeWhoTriedToKill", false, MadmateGuardImpostorKill);
            MadmateTasks = OverrideTasksData.Create(10014, TabGroup.ImpostorRoles, CustomRoles.Madmate);
