...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        public static CustomOption MechanicSkillLimit;
        public static CustomOption MechanicFixesDoors;
        public static CustomOption MechanicFixesReactors;
        public static CustomOption MechanicFixesOxygens;
        public static CustomOption MechanicFixesComms;
        public static CustomOption MechanicFixesElectrical;
        public static int MechanicUsedSkillCount;
        ...
        public static void Load()
        {
            ...
            SetupRoleOptions(20300, CustomRoles.Mechanic);
            MechanicSkillLimit = CustomOption.Create(20310, Color.white, "MechanicSkillLimit", 1, 0, 99, 1, CustomRoleSpawnChances[CustomRoles.Mechanic]);
            MechanicFixesDoors = CustomOption.Create(20311, Color.white, "MechanicFixesDoors", false, CustomRoleSpawnChances[CustomRoles.Mechanic]);
            MechanicFixesReactors = CustomOption.Create(20312, Color.white, "MechanicFixesReactors", false, CustomRoleSpawnChances[CustomRoles.Mechanic]);
            MechanicFixesOxygens = CustomOption.Create(20313, Color.white, "MechanicFixesOxygens", false, CustomRoleSpawnChances[CustomRoles.Mechanic]);
            MechanicFixesComms = CustomOption.Create(20314, Color.white, "MechanicFixesCommunications", false, CustomRoleSpawnChances[CustomRoles.Mechanic]);
            MechanicFixesElectrical = CustomOption.Create(20315, Color.white, "MechanicFixesElectrical", false, CustomRoleSpawnChances[CustomRoles.Mechanic]);
