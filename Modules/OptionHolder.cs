...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        public static void Load()
        {
            ...
            SetupRoleOptions(10300, TabGroup.ImpostorRoles, CustomRoles.MadScientist);
            MadScientistCanSeeDeathReason = CustomOption.Create(10310, TabGroup.ImpostorRoles, Color.white, "MadScientistCanSeeDeathReason", true, CustomRoleSpawnChances[CustomRoles.MadScientist]);
            MadScientistCanSeeKillFlash = CustomOption.Create(10320, TabGroup.ImpostorRoles, Color.white, "MadScientistCanSeeKillFlash", true, CustomRoleSpawnChances[CustomRoles.MadScientist]);
            MadScientistNoticeImpostor = CustomOption.Create(10330, TabGroup.ImpostorRoles, Color.white, "MadScientistNoticeImpostor", true, CustomRoleSpawnChances[CustomRoles.MadScientist]);
            MadScientistGuardImpostorKill = CustomOption.Create(10340, TabGroup.ImpostorRoles, Color.white, "MadScientistGuardImpostorKill", true, CustomRoleSpawnChances[CustomRoles.MadScientist]);
            MadScientistCanSeeWhoTriedToKill = CustomOption.Create(10350, TabGroup.ImpostorRoles, Color.white, "MadScientistCanSeeWhoTriedToKill", true, MadScientistGuardImpostorKill);
            MadScientistTasks = OverrideTasksData.Create(10360, TabGroup.ImpostorRoles, CustomRoles.MadScientist);
            ...
            ArsonistCooldown = CustomOption.Create(50511, TabGroup.NeutralRoles, Color.white, "ArsonistCooldown", 10, 5, 100, 1, CustomRoleSpawnChances[CustomRoles.Arsonist]);
            ...
            JackalKillCooldown = CustomOption.Create(50910, TabGroup.NeutralRoles, Color.white, "JackalKillCooldown", 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.Jackal]);
            JackalCanVent = CustomOption.Create(50911, TabGroup.NeutralRoles, Color.white, "JackalCanVent", true, CustomRoleSpawnChances[CustomRoles.Jackal]);
            JackalCanUseSabotage = CustomOption.Create(50912, TabGroup.NeutralRoles, Color.white, "JackalCanUseSabotage", false, CustomRoleSpawnChances[CustomRoles.Jackal]);
            JackalHasImpostorVision = CustomOption.Create(50913, TabGroup.NeutralRoles, Color.white, "JackalHasImpostorVision", true, CustomRoleSpawnChances[CustomRoles.Jackal]);
