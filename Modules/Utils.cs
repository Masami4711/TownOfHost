        ...
        public static bool HasTasks(GameData.PlayerInfo p, bool ForRecompute = true)
        {
            ...
            else
            {
                ...
                if (cRoleFound)
                {
                    ...
                    if (cRole == CustomRoles.Madmate && (ForRecompute || (!Options.MadmateNoticeImpostors.GetBool() && !Options.MadmateGuardImpostorKill.GetBool()))) hasTasks = false;
            ...
            foreach (var seer in seerList)
            {
                ...
                )
                {
                    foreach (var target in PlayerControl.AllPlayerControls)
                    {
                        ...
                        if (seer.Is(RoleType.Impostor) && target.Is(CustomRoles.Madmate) && target.GetPlayerTaskState().IsTaskFinished && Options.MadmateCanAlsoBeExposedToImpostor.GetBool())
                            TargetMark += Helpers.ColorString(GetRoleColor(CustomRoles.Madmate), "★");
