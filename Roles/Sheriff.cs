...
namespace TownOfHost
{
    public static class Sheriff
    {
        ...
        public static CustomOption CanKillContrarian;
        ...
        public static void SetupCustomOption()
        {
            ...
            KillCooldown = CustomOption.Create(Id + 10, TabGroup.CrewmateRoles, Color.white, "KillCooldown", 30, 0, 990, 1, Options.CustomRoleSpawnChances[CustomRoles.Sheriff]);
            ...
            CanKillContrarian = CustomOption.Create(Id + 24, TabGroup.CrewmateRoles, Color.white, "SheriffCanKill%role%", true, CanKillNeutrals, replacementDic: SheriffCanKillRole(CustomRoles.Contrarian));
        }
        ...
        public static bool CanBeKilledBySheriff(this PlayerControl player)
        {
            ...
            return cRole switch
            {
                ...
                CustomRoles.Contrarian => CanKillContrarian.GetBool(),
