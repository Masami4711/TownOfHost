...
他プレイヤーの役職が分かるインポスターです。<br>
味方インポスターの役職やその能力の使用状況が見えます。<br>
自分がキルした相手の役職も見ることができます。<br>
キルを重ねればマッドメイトを表示する設定もあります。<br>
...
タスクフェーズ中、一度だけほぼ全てのキルを防ぎます。<br>
再びキルされた時か、キルを防いだ次の会議終了後に死亡します。<br>
キルを防いだことはキルしようとした人にしか分かりません。<br>
...
判定 : エンジニア<br>
カウント : クルー<br>
勝利条件 : 次の①、②のいずれかを満たす<br>
- ①. 生存且つクルー陣営の勝利<br>
- ②. 「脱出」後且つタスク完了後、クルー陣営以外の勝利又は全滅<br>

「脱出」することでゲームから離脱できる役職です。<br>
生存時はクルーと同じ勝利条件（①）を持ち、タスクカウントもされます。<br>
一定数タスクを完了するとベントに入れるようになり、入ると即座に「脱出」し、ゲームから離脱します。<br>
脱出すると死亡扱い（死因：脱出）となり死体は残らず、勝利条件がクルー陣営の敗北（②）に変わります。<br>
タスクを全て完了後にクルー陣営以外が勝利するか全滅することで勝利となります。<br>
脱出以外による死亡、脱出後のタスク未完了、条件以外の陣営の勝利は全て敗北となります。<br>

- 勝利条件②で全滅時のみ単独勝利、他では追加勝利となります。<br>
- 逃亡者が複数いる場合、条件を満たせば何人でも同時に勝利できます。<br>
- 脱出できない段階でベントに入ろうとしても入れません。<br>
- 脱出可能時、脱出後タスク未完了時にメッセージが表示されます。<br>
- 脱出後、死亡後はタスクカウントされません。<br>
- 脱出と同時に勝利もできますが、タスクを予め終わらせておく必要があります。<br>
