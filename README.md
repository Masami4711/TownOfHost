...
| [ShapeMaster/シェイプマスター](#ShapeMasterシェイプマスター)       | [Mechanic/メカニック](#Mechanicメカニック) | [Terrorist/テロリスト](#Terroristテロリスト)                               |
...
爆弾の爆破によって大量キル出来る役職です。<br>
最大3個の爆弾をシェイプシフトのタイミングで設置出来ます。<br>
すべての爆弾を設置したら、最後のインポスターとなった時にシェイプシフトのタイミングで一斉起爆します。<br>
爆弾を設置し始めてから爆破するまでキル出来ません。<br>
...
| 設定名                                                                         |
| ------------------------------------------------------------------------------ |
| メカニックがサボタージュに対して能力を使用できる回数(ドア閉鎖は除く) |
| メカニックが 1 度に複数のドアを開けることを許可する                  |
| メカニックが原子炉メルトダウンに対して能力を使える                   |
| メカニックが酸素妨害に対して能力を使える                             |
| メカニックが MIRA HQ の通信妨害に対して能力を使える                  |
| メカニックが停電に対して能力を使える                                 |
