...
クルーに重複して割当てられる属性です。<br>
クルーにも関わらずシェリフにキルされてしまいます。<br>
設定次第ではタスクを終えたスニッチからも赤く表示されます。<br>
自分がシェリフ以外の場合、ある程度タスクを進めないと自分がスケープゴートだとは分かりません。<br>
...
インポスターに重複して割当てられる属性です。<br>
インポスターにも関わらずシェリフでキルできません。<br>
設定次第ではタスクを終えたスニッチも欺くことができます。<br>
ただし、死亡後は全員からクリミナルだと分かってしまいます。<br>
