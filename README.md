...
判定 : エンジニア<br>
カウント : クルー<br>
勝利条件 : 次のＡ、Ｂのいずれかを満たす<br>
  Ａ. 生存且つクルー陣営の勝利<br>
  Ｂ. 「脱出」後且つタスク完了後、クルー陣営以外の勝利又は全滅<br>

「脱出」することでゲームから離脱できる役職です。<br>
生存時はクルーと同じ勝利条件（Ａ）を持ち、タスクカウントもされます。<br>
一定数タスクを完了するとベントに入れるようになり、入ると即座に「脱出」し、ゲームから離脱します。<br>
脱出すると死亡扱い（死因：脱出）となり死体は残らず、勝利条件がクルー陣営の敗北（Ｂ）に変わります。<br>
タスクを全て完了後にクルー陣営以外が勝利するか全滅することで勝利となります。<br>
脱出以外による死亡、脱出後のタスク未完了、条件以外の陣営の勝利は全て敗北となります。<br>

- 勝利条件Ｂで全滅時のみ単独勝利、他では追加勝利となります。<br>
