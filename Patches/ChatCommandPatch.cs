    ...
    class ChatCommands
    {
        ...
        public static void getRolesInfo(string role)
        {
            switch (role)
            {
                ...
                case "guesser":
                case "gue":
                    Utils.SendMessage(getString("GuesserInfoLong"));
                    break;
