    ...
    class ChatCommands
    {
        ...
        public static void getRolesInfo(string role)
        {
            switch (role)
            {
                ...
                case "madmayor":
                case "mmy":
                    Utils.SendMessage(Utils.getRoleName(CustomRoles.MadMayor) + getString("MadMayorInfoLong"));
                    break;
