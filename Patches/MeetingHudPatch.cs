    ...
    class MeetingHudStartPatch
    {
        ...
        public static void Postfix(MeetingHud __instance)
        {
            ...
            foreach (var pva in __instance.playerStates)
            {
                ...
                {
                    bool IncludeScapegoat = seer.Is(CustomRoles.Snitch) && !(seer.Data.IsDead && Options.GhostCanSeeOtherRoles.GetBool()) && target.Is(CustomRoles.Scapegoat) && Options.ScapegoatLooksRedForSnitch.GetBool();
                    bool ExcludeCriminal = seer.Is(CustomRoles.Snitch) && !(seer.Data.IsDead && Options.GhostCanSeeOtherRoles.GetBool()) && target.Is(CustomRoles.Criminal) && Options.CriminalCanDeceiveSnitch.GetBool();
