    ...
    class MeetingHudStartPatch
    {
        ...
        public static void Postfix(MeetingHud __instance)
        {
            ...
            foreach (var pva in __instance.playerStates)
            {
                ...
                if ((seer.Is(CustomRoles.Snitch) || seer.Is(CustomRoles.MadSnitch) || (seer.Is(CustomRoles.MadScientist) && Options.MadScientistNoticeImpostor.GetBool())) && //seerがSnitch/MadSnitch
