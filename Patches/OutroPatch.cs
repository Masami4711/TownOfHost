    ...
    class EndGamePatch
    {
        ...
        public static void Postfix(AmongUsClient __instance, [HarmonyArgument(0)] ref EndGameResult endGameResult)
        {
            ...
            foreach (var pc in PlayerControl.AllPlayerControls)
            {
                ...
                if (pc.Is(CustomRoles.Contrarian) && (!pc.Data.IsDead || Options.ContrarianCanWinAfterDeath.GetBool()) && !(CustomWinnerHolder.WinnerTeam is CustomWinner.Draw or CustomWinner.Crewmate))
                {
                    winner.Add(pc);
